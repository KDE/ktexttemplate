...
QString NullLocalizer::localizeTime(const QTime &time,
                                    QLocale::FormatType formatType) const
{
  Q_UNUSED(formatType)
...
QString NullLocalizer::localizeDateTime(const QDateTime &dateTime,
                                        QLocale::FormatType formatType) const
{
  Q_UNUSED(formatType)
...
QString NullLocalizer::localizeMonetaryValue(qreal value,
...
QString
NullLocalizer::localizeContextString(const QString &string,
...
QString NullLocalizer::localizePluralContextString(
    const QString &_string, const QString &_pluralForm, const QString &context,
...
QString NullLocalizer::localizeString(const QString &string,
                                      const QVariantList &arguments) const
{
  return substituteArguments(string, arguments);
}
...
QString
NullLocalizer::localizePluralString(const QString &_string,
                                    const QString &_pluralForm,
                                    const QVariantList &_arguments) const
{
  const auto count = _arguments.first().value<int>();
  auto arguments = _arguments;
...
void NullLocalizer::unloadCatalog(const QString &catalog) { Q_UNUSED(catalog) }
