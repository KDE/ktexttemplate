...
SafeString::SafeString(const QString &str, bool safe)
    : m_nestedString(str, this), m_safety(safe ? IsSafe : IsNotSafe),
      m_needsescape(false)
{
}

SafeString::SafeString(const QString &str, Safety safety)
    : m_nestedString(str, this), m_safety(safety), m_needsescape(false)
{
}
...
bool SafeString::isSafe() const { return m_safety == IsSafe; }
...
SafeString::NestedString::NestedString(const QString &content,
                                       SafeString *safeString)
...
SafeString &SafeString::NestedString::insert(int position, const QChar *unicode,
                                             int size)
{
...
SafeString &SafeString::NestedString::remove(const QString &str,
                                             Qt::CaseSensitivity cs)
{
  QString::remove(str, cs);
  m_safeString->m_safety = IsNotSafe;
...
SafeString &SafeString::NestedString::replace(const QChar *before, int blen,
...
SafeString &SafeString::NestedString::replace(QChar ch, const SafeString &after,
                                              Qt::CaseSensitivity cs)
{
...
SafeString &SafeString::NestedString::replace(QChar ch, const QString &after,
                                              Qt::CaseSensitivity cs)
{
...
SafeString &SafeString::NestedString::replace(QChar before, QChar after,
                                              Qt::CaseSensitivity cs)
{
  QString::replace(before, after, cs);
  m_safeString->m_safety = IsNotSafe;
...
SafeString &SafeString::NestedString::setNum(double n, char format,
                                             int precision)
{
...
SafeString &SafeString::NestedString::setNum(float n, char format,
                                             int precision)
{
  QString::setNum(n, format, precision);
  m_safeString->m_safety = IsNotSafe;
